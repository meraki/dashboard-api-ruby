...
Gem::Specification.new do |s|
  ...
  s.summary     = 'A Ruby implementation of the Meraki Dashboard API'
  s.description = 'A Ruby implementation of the Meraki Dashboard API. It allows you to interact and provision the Meraki Dashboard via their RESTful API'
